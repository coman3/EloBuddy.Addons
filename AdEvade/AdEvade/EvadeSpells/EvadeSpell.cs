...
namespace AdEvade.EvadeSpells
{
    class EvadeSpell
    {
        ...
        public static bool ActivateEvadeSpell(Data.Spell spell, bool checkSpell = false)
        {
        ...
        private static bool ShouldActivateEvadeSpell(Data.Spell spell)
        {
